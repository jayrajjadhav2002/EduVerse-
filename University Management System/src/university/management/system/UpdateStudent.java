...
public class UpdateStudent extends JFrame implements ActionListener{
    ...
    JTextField tfcourse, tfname, tffname, tdate, tfaddress, tfphone, tfemail, tx, txii, taadhar, tfbranch;
    JLabel labelrollno;
    ...
    UpdateStudent() {
        ...
        tx.setFont(new Font("Tahoma", Font.PLAIN, 18));
        add(tx);
        ...
        txii.setFont(new Font("Tahoma", Font.PLAIN, 18));
        add(txii);
        ...
        try {
            ...
            while(rs.next()) {
                ...
                tx.setText(rs.getString("class_x"));
                txii.setText(rs.getString("class_xii"));
